...
$scope.documentPath = '';
        ...
        loadDocument=function (response) {
            ...
            if (response.data.length > 0) {
                ...
                $scope.documentPath = "http://docs.google.com/gview?url=http://ec2-54-245-46-84.us-west-2.compute.amazonaws.com:3000/"+$scope.thisFile + "&embedded=true";
        ...
        $scope.getFilePath = function(){
            console.log("http://docs.google.com/gview?url=http://ec2-54-245-46-84.us-west-2.compute.amazonaws.com:3000/"+ $scope.thisFile +"&embedded=true");
